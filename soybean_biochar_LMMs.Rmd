...
Generate the ANOVA tables and estimated marginal means for each response variable. Use Kenward-Roger method for estimating denominator degrees of freedom in both cases (it's slightly more conservative).
